...
namespace detail {
inline void importPGM( std::string const& fileName, std::vector<unsigned char>& ppData, std::size_t& sx, std::size_t& sy )
{
...
inline void writePGM( std::string const& fileName, std::vector<unsigned char> const& data, std::size_t sx, std::size_t sy )
{
...
template <class T>
inline void importPGM( std::string const& fileName, T& data, std::size_t& sx, std::size_t& sy ) {
...
template <class T>
inline void exportPGM(std::string const& fileName, T const& data, std::size_t sx, std::size_t sy, bool normalize = false) {
