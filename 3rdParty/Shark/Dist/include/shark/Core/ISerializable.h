...
// [taktik] added: use eos binary instead of text archives in shark
#ifdef USE_TEXT_ARCHIVE_SERIALIZATION
  #include <boost/archive/polymorphic_iarchive.hpp>
  #include <boost/archive/polymorphic_oarchive.hpp>
  #include <boost/archive/polymorphic_text_iarchive.hpp>
  #include <boost/archive/polymorphic_text_oarchive.hpp>
#else
  #include <shark/Core/archive/portable_iarchive.hpp>
  #include <shark/Core/archive/portable_oarchive.hpp>
#endif
...
#else // use portable binary archives from eos
	/**
	* \brief Type of an archive to read from.
	*/
	typedef eos::portable_iarchive InArchive;
	typedef InArchive TextInArchive;

	/**
	* \brief Type of an archive to write to.
	*/
	typedef eos::portable_oarchive OutArchive;
	typedef OutArchive TextOutArchive;
#endif
